package com.miraclegenesis.framework.web.exception;
...
import com.miraclegenesis.framework.web.util.RequestContextUtils;
    ...
    private String getErrorMsgByEnvironment(Exception exception) {
        ...
        if (SpringContextUtil.isDev() || SpringContextUtil.isTest() || SpringContextUtil.isProd()) {
            ...
            for (StackTraceElement stackTraceElement : exception.getStackTrace()) {
                ...
                if (stackTraceElement.toString().contains("com.miraclegenesis")) {
