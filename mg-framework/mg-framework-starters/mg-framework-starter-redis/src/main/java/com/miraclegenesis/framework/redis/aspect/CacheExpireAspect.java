package com.miraclegenesis.framework.redis.aspect;


import com.miraclegenesis.framework.redis.annotation.CacheExpire;
import com.miraclegenesis.framework.redis.annotation.CacheExpireHolder;
...
public class CacheExpireAspect {
     ...
     * 设置方法对应的缓存过期时间
     */
    @Around("@annotation(com.miraclegenesis.framework.redis.annotation.CacheExpire)")
